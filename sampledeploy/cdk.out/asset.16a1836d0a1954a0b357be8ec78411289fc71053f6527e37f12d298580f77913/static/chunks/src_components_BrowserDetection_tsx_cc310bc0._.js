(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_components_BrowserDetection_tsx_cc310bc0._.js", {

"[project]/src/components/BrowserDetection.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const BrowserDetection = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BrowserDetection.useEffect": ()=>{
            // Function to detect Safari
            const isSafari = {
                "BrowserDetection.useEffect.isSafari": ()=>{
            ...
            const isDesktop = {
                "BrowserDetection.useEffect.isDesktop": ()=>{
                    return window.innerWidth >= 768;
                }
            }["BrowserDetection.useEffect.isDesktop"];
            // Function to detect mobile Safari specifically
            const isMobileSafari = {
                "BrowserDetection.useEffect.isMobileSafari": ()=>{
                    const ua = navigator.userAgent.toLowerCase();
            ...
            const deepFixPricing = {
                "BrowserDetection.useEffect.deepFixPricing": ()=>{
                    // Fix pricing card layout
                    document.querySelectorAll('#pricing .rounded-xl').forEach({
                        "BrowserDetection.useEffect.deepFixPricing": (card)=>{
                    ...
                    document.querySelectorAll('#pricing .p-8.flex.flex-col, #pricing .p-8.bg-white.flex.flex-col').forEach({
                        "BrowserDetection.useEffect.deepFixPricing": (topSection)=>{
                    ...
                    // Fix titles
                    document.querySelectorAll('#pricing h3').forEach({
                        "BrowserDetection.useEffect.deepFixPricing": (title)=>{
                    ...
                    document.querySelectorAll('#pricing .flex.items-baseline').forEach({
                        "BrowserDetection.useEffect.deepFixPricing": (container)=>{
                    ...
                    // Fix pricing amounts
                    document.querySelectorAll('#pricing .text-4xl').forEach({
                        "BrowserDetection.useEffect.deepFixPricing": (price)=>{
                    ...
                    // Fix pricing periods
                    document.querySelectorAll('#pricing .ml-2').forEach({
                        "BrowserDetection.useEffect.deepFixPricing": (period)=>{
                    ...
                    document.querySelectorAll('#pricing p.text-gray-600:not(.mt-8):not(.max-w-3xl)').forEach({
                        "BrowserDetection.useEffect.deepFixPricing": (description)=>{
                    ...
                    // Fix buttons
                    document.querySelectorAll('#pricing .mt-auto a').forEach({
                        "BrowserDetection.useEffect.deepFixPricing": (button)=>{
                    ...
                    document.querySelectorAll('#pricing .bg-gray-50.p-8').forEach({
                        "BrowserDetection.useEffect.deepFixPricing": (section)=>{
                    ...
                    document.querySelectorAll('#pricing .font-medium.mb-6').forEach({
                        "BrowserDetection.useEffect.deepFixPricing": (title)=>{
                    ...
                    // Fix feature list
                    document.querySelectorAll('#pricing .space-y-4').forEach({
                        "BrowserDetection.useEffect.deepFixPricing": (list)=>{
                    ...
                    document.querySelectorAll('#pricing .flex.items-start').forEach({
                        "BrowserDetection.useEffect.deepFixPricing": (item)=>{
                    ...
                    document.querySelectorAll('#pricing svg').forEach({
                        "BrowserDetection.useEffect.deepFixPricing": (icon)=>{
                    ...
                    document.querySelectorAll('#pricing [data-safari-grid="pricing-grid"]').forEach({
                        "BrowserDetection.useEffect.deepFixPricing": (grid)=>{
            ...
            const fixCentering = {
                "BrowserDetection.useEffect.fixCentering": ()=>{
                    // Fix container centering
                    document.querySelectorAll('.container').forEach({
                        "BrowserDetection.useEffect.fixCentering": (container)=>{
                    ...
                    document.querySelectorAll('.text-center').forEach({
                        "BrowserDetection.useEffect.fixCentering": (element)=>{
                            element.style.textAlign = 'center';
                        }
                    }["BrowserDetection.useEffect.fixCentering"]);
                    // Fix flex centering issues
                    document.querySelectorAll('.items-center').forEach({
                        "BrowserDetection.useEffect.fixCentering": (element)=>{
                            element.style.alignItems = 'center';
                        }
                    }["BrowserDetection.useEffect.fixCentering"]);
                    document.querySelectorAll('.justify-center').forEach({
                        "BrowserDetection.useEffect.fixCentering": (element)=>{
            ...
            const fixPricingSection = {
                "BrowserDetection.useEffect.fixPricingSection": ()=>{
                    ...
                    pricingCards.forEach({
                        "BrowserDetection.useEffect.fixPricingSection": (card)=>{
                            ...
                            if (bottomSection) {
                                ...
                                if (featureList) {
                                    ...
                                    featureItems.forEach({
                                        "BrowserDetection.useEffect.fixPricingSection": (item)=>{
                                            item.style.display = 'flex';
                                            item.style.alignItems = 'flex-start';
                                            item.style.marginBottom = '1rem';
            ...
            const fixButtonLayouts = {
                "BrowserDetection.useEffect.fixButtonLayouts": ()=>{
                    // Target flex containers with buttons (typically have flex-col with sm:flex-row)
                    document.querySelectorAll('.flex.flex-col').forEach({
                        "BrowserDetection.useEffect.fixButtonLayouts": (container)=>{
                    ...
                    if (heroButtons) {
                        ...
                        buttons.forEach({
                            "BrowserDetection.useEffect.fixButtonLayouts": (button)=>{
                    ...
                    document.querySelectorAll('.sm\\:flex-row').forEach({
                        "BrowserDetection.useEffect.fixButtonLayouts": (container)=>{
                            container.classList.remove('flex-col');
                            container.classList.add('flex-row');
                            container.style.justifyContent = 'center';
            ...
            const applyGridFixes = {
                "BrowserDetection.useEffect.applyGridFixes": ()=>{
                    ...
                    document.querySelectorAll('.grid').forEach({
                        "BrowserDetection.useEffect.applyGridFixes": (grid)=>{
                            // For md:grid-cols-2
            ...
            const applyAllSafariDesktopFixes = {
                "BrowserDetection.useEffect.applyAllSafariDesktopFixes": ()=>{
                    // Add desktop classes
                    ...
                    document.querySelectorAll('.container').forEach({
                        "BrowserDetection.useEffect.applyAllSafariDesktopFixes": (container)=>{
...
_s(BrowserDetection, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = BrowserDetection;
const __TURBOPACK__default__export__ = BrowserDetection;
var _c;
__turbopack_context__.k.register(_c, "BrowserDetection");
...
//# sourceMappingURL=src_components_BrowserDetection_tsx_cc310bc0._.js.map