...
import { TEMPLATE_PROMPT } from '../prompts/template';
...
export async function generateSoapNote(
  ...
  const input: CompletionInput = {
    ...
    messages: [
      {
        role: "system",
        content: SOAP_NOTE_PROMPT(contextPrompt, existingDetails)
      } as ChatCompletionSystemMessageParam,
      {
        role: "user",
        content: transcript
...
export async function generateTemplateNote(
  ...
  const input: CompletionInput = {
    ...
    messages: [
      {
        role: "system",
        content: TEMPLATE_PROMPT(contextPrompt, existingDetails)
      } as ChatCompletionSystemMessageParam,
      {
        role: "system",
