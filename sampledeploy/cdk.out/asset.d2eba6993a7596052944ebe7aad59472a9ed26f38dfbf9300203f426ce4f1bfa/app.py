...
def get_secrets():
    ...
    try:
        ...
        logger.debug(f"Retrieved secrets keys: {list(secrets.keys())}")  # Log available keys without exposing values
        ...
        # Log which values we have from environment (without exposing the values)
