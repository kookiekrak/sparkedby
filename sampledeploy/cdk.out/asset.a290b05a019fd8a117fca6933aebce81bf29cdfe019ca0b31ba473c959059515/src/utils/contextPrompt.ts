...
export async function getContextPrompt(userId: string, serviceClient: SupabaseClient): Promise<string> {
  try {
...
function generatePrompt(userContext?: UserContext): string {
