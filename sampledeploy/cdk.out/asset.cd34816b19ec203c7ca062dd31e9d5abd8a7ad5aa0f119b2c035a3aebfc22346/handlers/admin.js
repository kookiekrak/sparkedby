...
exports.handleVisitRegeneration = void 0;
const admin_1 = require("../config/admin");
const containerText_1 = require("./containerText");
const handleVisitRegeneration = async (req, res) => {
    const { visitId } = req.body;
    const userEmail = req.user.email;
    if (!admin_1.ADMIN_EMAILS.includes(userEmail)) {
    ...
    try {
        ...
        const soapNote = await (0, containerText_1.generateAndSaveSoapNote)(visitId, fullText, serviceClient, visitData.user_id, nextVersion // Pass version to the generation function
        );
...
exports.handleVisitRegeneration = handleVisitRegeneration;
