...
exports.handleUpdateContainerText = void 0;
exports.generateAndSaveSoapNote = generateAndSaveSoapNote;
const aiService_1 = require("../services/aiService");
async function generateAndSaveAIContext(visitId, transcriptFragment, serviceClient, userId) {
    try {
        const aiContext = await (0, aiService_1.generateAIContext)(visitId, transcriptFragment, serviceClient, userId);
...
async function generateAndSaveSoapNote(visitId, transcript, serviceClient, userId, version = 1 // Default to version 1 if not specified
) {
    try {
        const soapNote = await (0, aiService_1.generateSoapNote)(visitId, transcript, serviceClient, userId);
        const { error: noteError } = await serviceClient
            .from('notes')
            .insert({
            visit_id: visitId,
...
async function processFinalContainer(visitId, serviceClient, userId) {
...
const handleUpdateContainerText = async (req, res) => {
    try {
...
exports.handleUpdateContainerText = handleUpdateContainerText;
