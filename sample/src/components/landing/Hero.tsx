 ...
 * It includes a headline, tagline, waitlist form, and feature highlights.
 * 
 * Configuration:
 * - Set VITE_COMPANY_NAME in .env file to customize the company name
 * - Set VITE_TAGLINE to customize the tagline
...
const Hero = () => {
  return (
    <section className="pt-24 pb-16 md:pt-32 md:pb-24 relative overflow-hidden">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-purple-50 opacity-70" style={{ background: `linear-gradient(to bottom right, ${import.meta.env.VITE_PRIMARY_COLOR || '#3b82f6'}20, ${import.meta.env.VITE_SECONDARY_COLOR || '#a855f7'}20)` }}></div>
