...
[Clinician Name]', NULL, NULL, NULL, NULL, '2025-03-11 20:36:36.817965+00', '2025-03-11 20:36:36.817965+00', 'translated_note', 1, false);
...
INSERT INTO "public"."template_library" ("id", "name", "description", "prompt", "sample_output", "specialty", "tags", "owner_id", "created_at", "updated_at", "version_id", "published", "type") VALUES ('4fde802c-2d16-4090-8089-6a796b467874', 'SOAP - Optometry', '
This Optometrist''s note template is designed for documenting comprehensive eye examinations. It includes sections for subjective complaints, objective findings, assessments, and plans. Optometrists can use this template to record details such as visual acuity, intraocular pressure, and anterior and posterior segment findings. The template also allows for the inclusion of family ocular history, medication history, and any additional tests performed. This structured format ensures thorough documentation, aiding in accurate diagnosis and treatment planning. Ideal for optometrists, this template streamlines the documentation process, enhancing patient care and follow-up management.', 'Subjective:
...
- Issued prescription for glasses [OD Sphere, Cylinder, Axis, Distance Prism, VA, Near Add, Near Prism, Near VA, OS Sphere, Cylinder, Axis, Distance Prism, VA, Near Add, Near Prism, Near VA]', 'Subjective:
- Chief Complaint: Blurred vision in the right eye
- History of Present Illness: The patient reports blurred vision in the right eye for the past two weeks, with no associated pain or redness.
- Past Ocular History: History of myopia, no previous surgeries or treatments.
- Medical History: Hypertension, well-controlled with medication.
- Medication History: Lisinopril 10mg daily.
- Allergies: No known drug allergies.
- Family Ocular History: Father has glaucoma.
...
- Issued prescription for glasses: OD Sphere -2.00, Cylinder 0.00, Axis 0, Distance Prism 0, VA 6/6, Near Add +1.00, Near Prism 0, Near VA N5; OS Sphere -1.50, Cylinder 0.00, Axis 0, Distance Prism 0, VA 6/6, Near Add +1.00, Near Prism 0, Near VA N5', 'Optometrist', null, null, '2025-03-21 06:29:49.24436+00', '2025-03-21 06:29:49.24436+00', '1', 'false', 'note');
